...
const REDIRECT_URI = `https://fair-lime-sweater.cyclic.app/oauth-callback`;
...
const CONNECTION_URL = "mongodb+srv://ckurata123:test@cluster0.lpxpizx.mongodb.net/?retryWrites=true&w=majority";
...
app.post("/", function(req, res){  collection.insertOne(req.body, (err, result) => {  
    ...
    var url = 'https://api.hsforms.com/submissions/v3/integration/submit/8797284/fd79ca62-1280-41eb-be26-a1b39297852a'
 ...
 formv3();
    ...
    res.redirect('/thankyou') // or do something else here
  })})
